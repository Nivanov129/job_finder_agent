"""Эмбеддинги пре-фильтра (стадия 4): фиксированная локальная модель bge-m3.

Модель фиксирована (`BAAI/bge-m3` через fastembed) и НЕ зависит от выбора
...
# Фиксированная модель пре-фильтра. Не конфигурируется — инвариант продукта.
